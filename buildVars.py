...
addon_info = {
	...
	"addon_name": "musescore4",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	"addon_summary": _("musescore4"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	"addon_description": _("Addon personal que añade una pequeña función para filtrar  el nombre de las notas en lugar del cifrado, y que evita la información poco relevante para la lectura de partituras. También bloquea las flechas arriba y abajo para la modificación involuntaria de las notas durante la lectura"),
	# version
	"addon_version": "1.0",
	# Author(s)
